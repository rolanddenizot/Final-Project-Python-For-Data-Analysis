...
Purpose: Study the relationships between chemical structures and biodegradation of molecules. Determine if a chemical is ready-biodegradable or not.
...
Tasks: 
- Data-Visualization
- Modelizations with machine learning models, tuning of hyperparameters
